...
myTrainData = pd.read_csv("/Users/gokhangoy/Desktop/Yaptigim Calismalar/HyperParameterOptimization/trainData2.csv",sep=";")
h_myTrainYData = pd.read_csv("/Users/gokhangoy/Desktop/Yaptigim Calismalar/HyperParameterOptimization/HyperParameterOptimizationYData.csv", sep=";")
...
# =============================================================================
#     model = multi_gpu_model(logisticRegressionModel, gpus=3)                           
# =============================================================================
    model=Sequential()
...
scan_object = talos.Scan(X,
                         h_myTrainYData_Array, 
                         params=p,
                         model=logisticRegressionModel,
                         random_method='quantum',
                         experiment_name='LRTuning')
